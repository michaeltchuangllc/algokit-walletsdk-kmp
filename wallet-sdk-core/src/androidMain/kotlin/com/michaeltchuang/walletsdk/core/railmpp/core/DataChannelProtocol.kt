 ...
 */
internal fun PaymentRequest.toJson(): JSONObject = JSONObject().apply {
    put("id", id)
 ...
 */
internal fun RailPayment.toJson(): JSONObject = JSONObject().apply {
    put("railId", railId)
    put("version", version)
    put("nonce", nonce)
 ...
 */
internal fun railPaymentFromJson(json: JSONObject): RailPayment = RailPayment(
 ...
 */
internal fun PaymentReceipt.toJson(): JSONObject = JSONObject().apply {
    put("txId", txId)
    put("sessionId", sessionId)
    put("segmentIndex", segmentIndex)
    put("amount", amount)
