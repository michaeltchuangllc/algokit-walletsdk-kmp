...
internal expect fun signEd25519(secretKey: ByteArray, message: ByteArray): ByteArray?

/** Verifies an Ed25519 [signature] over [message] using the 32-byte [publicKey]. */
internal expect fun verifyEd25519(publicKey: ByteArray, message: ByteArray, signature: ByteArray): Boolean
