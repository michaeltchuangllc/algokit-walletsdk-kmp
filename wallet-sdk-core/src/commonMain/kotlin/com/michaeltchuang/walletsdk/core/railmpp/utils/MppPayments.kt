...
object MppPayments {
    ...
    fun createVoucherJson(
        ...
        return buildString {
            append("""{"reference":"liquid:payment:voucher","id":"$sessionId","appId":$appId""")
            append(""","viewer":"$viewerAddress","viewerPublicKey":"$viewerPkBase64""")
            append(""","creator":"$creatorAddress","blocksWatched":$blocksConsumed""")
            append(""","costPerBlockMicroUsdc":$COST_PER_BLOCK_MICRO_USDC""")
            append(""","totalAmountClaimedMicroUsdc":$totalAmountUsed""")
            append(""","remainingMicroUsdc":$remainingMicroUsdc$sigField}""")
        }
    }
