...
```kotlin
dependencies {
    implementation("com.michaeltchuang.algokit.walletsdk:wallet-sdk-ui:3.202601.5")
    implementation("com.michaeltchuang.algokit.walletsdk:wallet-sdk-core:3.202601.5")
}
```
